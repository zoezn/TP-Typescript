...
class PieChart {
  private readonly colors = ["#dc9c9c", "#FBBC05", "#EA4335", "#4285F4"];
  ...
  private onMouseOver(event: MouseEvent) {
    const { clientX, clientY, radius, angle, dataIdx } =
...
const pieChartElement: HTMLCanvasElement = <HTMLCanvasElement>(
  document.getElementById("pieChart")
);
const tooltipElement: HTMLCanvasElement = <HTMLCanvasElement>(
